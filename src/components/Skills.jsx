  ...
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-dark text-light
              ...
              lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent xs:dark:text-light xs:text-dark xs:font-bold
              "
  ...
  return (
    <>
      ...
      >
        ...
        <Skill name="NetCore" x="15vw" y="-12vw" />
